...
typedef struct PhoneForward PhoneForward; ///< Definicja typu PhoneForward.
typedef struct PhoneNumbers PhoneNumbers; ///< Definicja typu PhoneNumbers.
 ...
 *         udało się alokować pamięci albo @p pf równa się NULL.
 */
PhoneNumbers *phfwdGet(PhoneForward const *pf, char const *num);

/** @brief Wyznacza numery z odpowiadającym prefiksem.
 * Wyznacza następujący ciąg numerów: jeśli istnieje taki prefiks
 * numeru @p x, że po zamianie go na odpowiadający mu numer w @p pf otrzymam
 * numer @p num to @p x należy do wyniku wywołania @ref phfwdReverse z numerem
 * @p num. Dodatkowo ciąg wynikowy zawsze zawiera też numer @p num.
